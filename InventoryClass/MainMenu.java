...
/*
 * Harry Newman; Final Project; MainMenu Class; May 12, 2023;
 */
...
public class MainMenu {
    ...
    //manages the cart and it's data
    public void Cart()
    {   
        cartArr = cartData();
        ...
        for (int p = 0; p < cartArr.length; p++)
        {
            for (int z = 0; z < itemsArr.length; z++)
            {
                ...
                if (cartItem.equals(inventorycheckString))
                {
                    ...
                    i.updateItem(inventorycheckString, remainderString);
                    break;
                }
            }
        }
    ...
    //creates a new file to fill the cart
    ...
    //takes collected inventorydata and updates the itemsArr
    ...
    //goes through the inventory data and converts the file into text
    ...
    //initializes the mainmenu and checks to see if the user is a manager or a customer
    public MainMenu(String username, String manager) {
        this.username = username;
        if (manager.equals("Manager")) {
            System.out.println(username + " is a Manager");
            ManagerMenu(username); //if the user is a manager, open manager GUI
        } else if (manager.equals("Customer")) {
            System.out.println(username + " is a Customer");//if the user is a customer, open customer GUI
    ...
    public void CustomerMenu(String username) {
        ...
        //this should use the Customer.java class and resave the UserArr into the User.txt file, waiting on Jeremy's code
